...
class UserSeeder extends Seeder
{
    ...
    $users = [
        ...
        ['name' => 'Sara Ali', 'email' => 'sara@client.com', 'password' => bcrypt('password'), 'role' => 'client', 'is_verified' => true, 'city_id' => 2],
        ...
        ['name' => 'Robert Fox', 'email' => 'robert@client.com', 'password' => bcrypt('password'), 'role' => 'client', 'is_verified' => true, 'city_id' => 4],
        ...
        ['name' => 'Elena Rossi', 'email' => 'elena@client.com', 'password' => bcrypt('password'), 'role' => 'client', 'is_verified' => true, 'city_id' => 6],
        ...
        ['name' => 'Youssef Zen', 'email' => 'youssef@free.com', 'password' => bcrypt('password'), 'role' => 'freelancer', 'is_verified' => false, 'city_id' => 1],
