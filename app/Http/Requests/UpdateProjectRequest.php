...
class UpdateProjectRequest extends FormRequest
{
    ...
    public function authorize(): bool
    {
        ...
        return $this->user()->role === 'client' && $this->user()->id == $project->user_id;
    }
    ...
    {
        return [
            'title' => ['sometimes','string','max:255','min:30',
            new NoOffensiveWords],
            'description' => ['sometimes', 'string', 'max:2000', 'min:200', new NoOffensiveWords],
